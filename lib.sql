...
insert into branch(branch_id ,emp_id , branch_address,	contact_no)
values('B001', 'E109', '123 Main St', '91900000'),
('B002', 'E109', '456 Elm St', '91900000'),
('B003', 'E109', '789 Oak St', '91900000'),
('B004', 'E110', '567 Pine St', '91900000'),
('B005', 'E110', '890 Maple St', '91900000');
select count(*) from branch;

use lib;
/* assisgning the foreign key*/
...
# foreign key (branch_id) refrences branch(branch_id) **
/* syntax for constraints
create table high_tempreture(
city varchar(50),
year int,
high_temp int,
constraint check (year between 1880 and 2000),
constraint check (high_temp > 100),
primary key(city. year),
);
*/

alter table return_status
drop constraint fk_issued_id_;
alter table return_status
drop constraint fk_;
alter table issued_status
drop constraint fk_issued_emp_id;
...
statement to create a new table active_members containing members who have issued at least one book in the last 2 months.*/
